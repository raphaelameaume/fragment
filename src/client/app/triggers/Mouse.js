...
export const checkForTriggersDown = (event, context) =>
	checkForTriggers(downs, event, context);
export const checkForTriggersMove = (event, context) =>
	checkForTriggers(moves, event, context);
export const checkForTriggersUp = (event, context) =>
	checkForTriggers(ups, event, context);
