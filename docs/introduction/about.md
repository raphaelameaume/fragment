...
- reactive to different kinds of inputs (GUIS, keyboard, MIDI, mouse, sound...) from the code and the interface
- fast as possible
- images, videos and live exports

So I spent the last years building my own tool.
